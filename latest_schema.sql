...
CREATE TABLE payments (
    ...
    payment_method ENUM('card','external_processor','in_person') NOT NULL DEFAULT 'card',
    ...
    CONSTRAINT chk_payments_reservation_booking CHECK (payment_type <> 'reservation' OR booking_id IS NOT NULL),

...
$nextShift = $stmt->fetch();

// Load employee hours for current week.
        ...
        <section class="container">
            ...
            <section class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a class="btn btn-success" href="employee-dashboard.php">
            ...
            <section class="row g-4 mb-4">
                        ...
                        <section class="row g-3 mt-4">
                            ...
                            <article class="col-md-4">
                                <section class="stats-card h-100">
                                    <p class="small text-uppercase text-muted mb-1">Next shift</p>
                                    <h2 class="h5 fw-bold mb-2"><?= $nextShift ? date('M d', strtotime($nextShift['shift_date'])) : 'No shift' ?></h2>
                                    <p class="text-muted mb-0"><?= $nextShift ? e($nextShift['park_name']) . ' · ' . date('g:i A', strtotime($nextShift['start_time'])) . '–' . date('g:i A', strtotime($nextShift['end_time'])) : 'No upcoming shift assigned.' ?></p>
                                </section>
                            </article>
                            ...
                            <article class="col-md-4">
                                <section class="stats-card h-100">
                                    <p class="small text-uppercase text-muted mb-1">Hours this week</p>
                                    <h2 class="h3 fw-bold mb-2"><?= $hoursWeek ?></h2>
                                    <p class="text-muted mb-0">Based on assigned schedule blocks.</p>
                                </section>
                            </article>
                            ...
                            <article class="col-md-4">
                                <section class="stats-card h-100">
                                    <p class="small text-uppercase text-muted mb-1">PTO status</p>
                                    <h2 class="h5 fw-bold mb-2"><?= $ptoPending ?> pending</h2>
                                    <p class="text-muted mb-0"><?= e($ptoStatusText) ?></p>
                                </section>
                            </article>
                        </section>
                    </section>
                ...
                <article class="col-xl-4">
                    <section class="soft-card p-4 h-100">
                        ...
                        <a href="employee-schedule.php" class="action-card mb-3 text-decoration-none d-block">
                            <strong>View schedule</strong>
                            <span>See your upcoming shifts and park assignments.</span>
                        </a>

                        <a href="employee-pto.php" class="action-card text-decoration-none d-block">
                            <strong>Create PTO request</strong>
                            <span>Submit time off and track request status.</span>
                        </a>
                    </section>
                </article>
            </section>
            ...
            <section class="list-shell">
                ...
                <?php if ($shifts): ?>
                    <?php foreach ($shifts as $i => $shift): ?>
                        <section class="<?= $i < count($shifts) - 1 ? 'list-row' : '' ?> p-4">
                            <section class="row g-3">
                                <article class="col-md-4 fw-semibold"><?= e($shift['park_name']) ?></article>
                                <article class="col-md-4 text-muted"><?= date('m/d/Y', strtotime($shift['shift_date'])) ?></article>
                                <article class="col-md-4 text-muted"><?= date('g:i A', strtotime($shift['start_time'])) ?> – <?= date('g:i A', strtotime($shift['end_time'])) ?></article>
                            </section>
                        </section>
                    <?php endforeach; ?>
                <?php else: ?>

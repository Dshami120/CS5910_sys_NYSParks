                        ...
                        <article class="col-lg-1">
                            ...
                            <select name="category" class="form-select">
                                ...
                                <?php foreach ($categories as $categoryName): ?>
                                    <option value="<?= e($categoryName) ?>" <?= $category===$categoryName?'selected':'' ?>>
                                        <?= e($categoryName) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
        ...
        <section class="pb-5">
            <section class="container">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <?php if ($when !== 'upcoming'): ?>
                        <a href="events.php" class="small text-muted">Back to upcoming & current</a>
                    <?php endif; ?>
                </div>
                                    ...
                                    <section class="d-flex justify-content-between align-items-start gap-3 mb-3">
                                        ...
                                        <section class="text-end">
                                            ...
                                            <?php if ($event['event_type'] === 'private'): ?>
                                                <span class="badge text-bg-warning mb-1">Private</span>
                                            <?php else: ?>
                                                <span class="badge text-bg-success mb-1">Public</span>
                                            <?php endif; ?>

                                            <?php if ($event['event_type'] === 'public' && $isFull): ?>
                                        ...
                                        <section class="modal-body pt-3">
                                            ...
                                            <section class="d-flex flex-wrap gap-2 mb-3">
                                                ...
                                                <?php if ($myStatus === 'registered'): ?>
                                                    <span class="badge text-bg-primary">RSVP Confirmed</span>
                                                <?php endif; ?>
                                            ...
                                            <?php elseif ($canRsvp): ?>
                                                <form method="post" class="d-flex flex-column flex-md-row gap-2 align-items-md-center">
                                                    ...
                                                    <select name="guest_count" class="form-select" style="max-width: 130px;">
                                                        <?php for ($i=1; $i<=min(10, max(1, $spotsRemaining)); $i++): ?>

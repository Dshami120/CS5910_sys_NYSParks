  ...
  <main>
    <section class="page-hero-mini">
      <section class="container">
        <p class="section-kicker mb-2">Interactive discovery</p>
        <h1 class="display-6 fw-bold mb-3">Statewide park map</h1>
        <p class="text-muted col-lg-8 mb-0">
          This simple starter uses a live OpenStreetMap embed. Later, your real map API can replace it with park markers and filters.
        </p>
      </section>
    </section>
      ...
      <section class="container">
        <section class="row g-4">
          <article class="col-xl-9">
            <iframe
              class="map-frame"
              title="New York State map"
              src="https://www.openstreetmap.org/export/embed.html?bbox=-80.7%2C40.1%2C-71.5%2C45.4&layer=mapnik">
            </iframe>
          </article>

          <aside class="col-xl-3">
            <section class="soft-card p-4">
              <h2 class="h5 fw-bold mb-3">Map Notes</h2>
              <p class="text-muted mb-3">
                Select a park on the map in the future version to view park details, amenities, and events.
              </p>

              <ul class="list-unstyled m-0">
                <li class="mb-3"><strong>Jones Beach</strong><br /><span class="text-muted">Long Island</span></li>
                <li class="mb-3"><strong>Letchworth</strong><br /><span class="text-muted">Western New York</span></li>
                <li class="mb-3"><strong>Watkins Glen</strong><br /><span class="text-muted">Finger Lakes</span></li>
                <li><strong>Minnewaska</strong><br /><span class="text-muted">Hudson Valley</span></li>
              </ul>
            </section>
          </aside>
        </section>

...
// Handle public event RSVP cancellation.
if ($_SERVER['REQUEST_METHOD'] === 'POST' && post('action') === 'cancel_rsvp') {
    ...
    // Cancel active RSVP for this client email.
    $stmt = $db->prepare("
    UPDATE attendance
...
// Handle reservation fee payment.
...
// Calculate unpaid reservation fees.
...
<?php include __DIR__ . '/includes/header.php'; ?>
    ...
    <main class="container py-5">
        ...
        <!-- Page heading and client navigation -->
        <section class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a class="btn btn-success" href="client-dashboard.php">
                    <i class="bi bi-speedometer2"></i> Client Dash
                </a>
                <a class="btn btn-outline-dark" href="client-create-event.php">
        ...
        <section class="card shadow-sm border-0 rounded-4 mb-4" id="my-rsvps">
            <div class="card-body p-4 p-lg-5">
                ...
                <section class="list-shell mb-0">
                    ...
                    <?php foreach ($rsvps as $rsvp): ?>
                        ...
                        <section class="list-row p-4">
                            <section class="row g-3 align-items-start">
                                ...
                                <span class="status-pill <?= booking_status_class($rsvp['attendance_status']) ?>">
                                    <?= e(ucfirst(str_replace('_',' ', $rsvp['attendance_status']))) ?>
                                </span>
                                </article>
                    ...
                    <!-- Empty RSVP message -->
                    <?php if (!$rsvps): ?>
                        <section class="p-4 text-muted">No RSVPs yet. Browse public events to RSVP.</section>
                    <?php endif; ?>
                </section>
            </div>
        </section>
        ...
        <section class="card shadow-sm border-0 rounded-4 mb-4" id="my-bookings">
            <div class="card-body p-4 p-lg-5">
                ...
                <section class="list-shell mb-0">
                    ...
                    <?php foreach ($bookings as $booking): ?>
                        <section class="list-row p-4">
                            <section class="row g-3 align-items-start">
                                ...
                                <span class="status-pill <?= booking_status_class($booking['booking_status']) ?>">
                                    <?= e(ucfirst($booking['booking_status'])) ?>
                                </span>
                                </article>
                                ...
                                <article class="col-lg-2 text-muted">
                                    <?php if ($booking['payment_status']): ?>
                                        <span class="status-pill <?= booking_status_class($booking['payment_status']) ?>">
                    ...
                    <?php if (!$bookings): ?>
                        <section class="p-4 text-muted">No booking requests yet.</section>
                    <?php endif; ?>
                </section>
            </div>
        </section>
    ...
    <!-- Chart and dashboard scripts -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js"></script>
    <script src="js/dashboard-charts.js"></script>

    <script>
        // Initialize client dashboard scripts.

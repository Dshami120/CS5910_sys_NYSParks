...
// Build employee accounts URL with filters.
...
// Handle employee account form actions.
...
// Load all employees for dropdown groups.
    ...
    <main class="container py-5">
        ...
        <section class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a class="btn btn-success" href="admin-employee-accounts.php">
        ...
        <section class="card shadow-sm border-0 rounded-4 mb-4">
            <div class="card-body p-4 p-lg-5">
                ...
                <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-4">
                    ...
                    <a href="admin-employee-accounts.php" class="btn btn-outline-dark align-self-start">
                        ...
                        <div class="account-panel h-100">
                            ...
                            <div class="vstack gap-3">
                                        ...
                                        <?php if ($activeEmployees): ?>
                                            <optgroup label="Active Employees">
                                                <?php foreach ($activeEmployees as $emp): ?>
                                                    <option value="<?= (int)$emp['id'] ?>" <?= $selected && (int)$selected['id'] === (int)$emp['id'] ? 'selected' : '' ?>>
                                                        <?= e(full_name($emp)) ?> — <?= e($emp['email']) ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        <?php endif; ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="park_filter" onchange="this.form.submit()">
                                            ...
                                            <?php foreach ($parks as $park): ?>
                                                <option value="<?= (int)$park['id'] ?>" <?= $parkFilter === (int)$park['id'] ? 'selected' : '' ?>>
                                                    <?= e($park['name']) ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                ...
                                <div class="vstack gap-2">
                                    ...
                                    <?php if (!$employees): ?>
                                        <p class="text-muted mb-0">No employee accounts match these filters.</p>
                                    <?php endif; ?>
                                </div>
                            ...
                            <form class="row g-3" method="post">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="park_id" class="form-select form-select-lg">
                                        ...
                                        <?php foreach ($parks as $park): ?>
                                            <option value="<?= (int)$park['id'] ?>" <?= (int)($selected['park_id'] ?? 0)===(int)$park['id']?'selected':'' ?>>
                                                <?= e($park['name']) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>

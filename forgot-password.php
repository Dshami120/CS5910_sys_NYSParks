        ...
        <section class="container">
            <section class="auth-panel p-4 p-lg-5">
                ...
                <form method="post">
                    ...
                    <input type="text" name="first_name" class="form-control form-control-lg mb-3" placeholder="First name" required />

                    <!-- Last name field -->
                    <label class="form-label">Last name</label>
                    <input type="text" name="last_name" class="form-control form-control-lg mb-4" placeholder="Last name" required />

...
if (isset($_GET['download']) && $_GET['download'] === '1') {
    ...
    // Limit employee export to employee users.
...
// Build recent export display rows.
            ...
            <header class="mb-4">
                ...
                <section class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a class="btn btn-success" href="admin-csv.php">
                    ...
                    <section class="form-panel p-4 h-100">
                        ...
                        <form method="get">
                            ...
                            <select name="dataset" class="form-select mb-3">
                                <?php foreach ($allowed as $datasetName): ?>
                                    <option value="<?= e($datasetName) ?>">
                                        <?= e(ucwords(str_replace("_", " ", $datasetName))) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            ...
                            <button class="btn btn-success rounded-pill w-100">Generate CSV</button>
                        </form>
                    </section>
                </article>
